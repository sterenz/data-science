...
class RelationalDataProcessor(RelationalProcessor):
    ...
    def uploadData(self,path):
        ...
        if path.split(".")[1] == 'csv':
            ...
            # for each publication we create a column with internal ids
        ...
        if path.split(".")[1] == 'json':
            ...
            for idx, row in doi_single_authors_df.iterrows():
            ...
            merge_authorsID_and_orcID = merge(authorsID_df, doi_authors_orcidlst, left_on="doi_single_authors", right_on="lst_doi_authors")

            AuthorsID = merge_authorsID_and_orcID[["AuthorID"]]
            ...
            joined_auth = merge(publications, merge_authorsID_and_orcID, left_on="id", right_on="doi_single_authors", how="left")
            ...
            authors_joined = merge(cit_joined, merge_authorsID_and_orcID, left_on="doi", right_on="doi_single_authors")
            ...
            authors_joined_bc = merge(cit_joined_bc, merge_authorsID_and_orcID, left_on="doi", right_on="doi_single_authors")
            ...
            authors_joined_pp = merge(cit_joined_pp, merge_authorsID_and_orcID, left_on="doi", right_on="doi_single_authors")
