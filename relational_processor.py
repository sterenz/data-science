...
class RelationalDataProcessor(RelationalProcessor):
    ...
    def uploadData(self,path):
        ...
        if path.split(".")[1] == 'json':
            ...
            for idx, row in df_newauth.iterrows():
            ...
            merge_author_orcid = merge(authorsID_df, doi_authors_orcidlst, left_on="doi_single_authors", right_on="lst_doi_authors")

            AuthorsID = merge_author_orcid[["AuthorID"]]
            ...
            joined_auth = merge(publications, merge_author_orcid, left_on="id", right_on="doi_single_authors", how="left")
            ...
            authors_joined = merge(cit_joined, merge_author_orcid, left_on="doi", right_on="doi_single_authors")
            ...
            authors_joined_bc = merge(cit_joined_bc, merge_author_orcid, left_on="doi", right_on="doi_single_authors")
            ...
            authors_joined_pp = merge(cit_joined_pp, merge_author_orcid, left_on="doi", right_on="doi_single_authors")
